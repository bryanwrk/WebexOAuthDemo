...
####CHANGE THESE VALUES#####
bot_email = "joeyyin@sparkbot.io"
bot_name = "joey's"
bearer = "MmRkMWYwMGYtZDQ4Yy00MDY0LTlhMjAtNjdlMWE2ZDY0NmJkZTNkZDk5OTQtY2Y3"
...
def send_tropo(spark_msg):
    """
       This method is used for:
       -Sending a message to some one's cell phone via a Tropo SMS application just to notify a message was received in his google spreadsheet.
       """
    url = 'https://api.tropo.com/1.0/sessions'
    headers = {'accept':'application/json','content-type':'application/json'}
    values = {'token':'6d4f6844584b53556971454f4a5041434e437478664e695657766455695a4150685478697375466358635570', 'msg': spark_msg }
